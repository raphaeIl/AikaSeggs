...
{
    /// <inheritdoc />
    public partial class RenamePictureBookDBAndAddCharacterGroupId : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PictureBooks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PictureBooks_Accounts_UserCd",
                        column: x => x.UserCd,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PictureBooks_UserCd_CharacterId",
                table: "PictureBooks",
